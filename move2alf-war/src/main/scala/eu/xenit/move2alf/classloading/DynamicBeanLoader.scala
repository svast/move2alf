...
class DynamicClasspathScanner(var classPaths: Array[String]) extends ClasspathScanner {
 ...
 * @param classPaths
 */
class MixedClasspathScanner(var classPaths: Array[String]) extends ClasspathScanner {
    val systemClasspathScanner = new SystemClasspathScanner()
    val dynamicClasspathScanner = new DynamicClasspathScanner(classPaths)
