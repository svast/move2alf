...
<button type="button" style="float:right" onclick="deleteJob">Delete</button></a>
...
<table>
<tr>
<td style="font-weight:bold;"><a href="<spring:url value="/job/create/destination" htmlEscape="true" />" onclick="return popup(this, 'notes')">Create new destination</a></td>
<td></td>
</tr>
<tr>
...
<td><a href="" target="_blank">Configure</a></td>
</tr>
...
<input type="submit" value="Update job" style="float:right"/>
</form:form>
</div>
</div>
</body>
