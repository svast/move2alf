...
public class AuthenticationUtils implements CallbackHandler
{
     ...
     * @throws AuthenticationFault
     */
    public static void startSession(String username, String password, long timeoutInterval, String endpointAddress)
    	throws AuthenticationFault
	{
		startSession(username, password, endpointAddress);
    ...
    public static void endSession()
    {
        ...
        if (authenticationDetails != null)
        {
            try
            {
				String endpointAddress = authenticationDetails
				.getEndpointAddress();
		AuthenticationServiceSoapBindingStub authenticationService = endpointAddress == null ? WebServiceFactory
				.getAuthenticationService()
				: WebServiceFactory
						.getAuthenticationService(endpointAddress);
				authenticationService.endSession(authenticationDetails.getTicket());
