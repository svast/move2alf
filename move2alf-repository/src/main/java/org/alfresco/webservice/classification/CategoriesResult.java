...
public class CategoriesResult  implements java.io.Serializable {
    private org.alfresco.webservice.types.Reference node;

    private org.alfresco.webservice.classification.AppliedCategory[] categories;
    ...
    public CategoriesResult(
           ...
           org.alfresco.webservice.classification.AppliedCategory[] categories) {
           this.node = node;
     ...
     * @return node
     */
    public org.alfresco.webservice.types.Reference getNode() {
        return node;
    }
     ...
     * @param node
     */
    public void setNode(org.alfresco.webservice.types.Reference node) {
        this.node = node;
    }
     ...
     * @return categories
     */
    public org.alfresco.webservice.classification.AppliedCategory[] getCategories() {
        return categories;
    }
     ...
     * @param categories
     */
    public void setCategories(org.alfresco.webservice.classification.AppliedCategory[] categories) {
        this.categories = categories;
    }

    public org.alfresco.webservice.classification.AppliedCategory getCategories(int i) {
        return this.categories[i];
    }

    public void setCategories(int i, org.alfresco.webservice.classification.AppliedCategory _value) {
