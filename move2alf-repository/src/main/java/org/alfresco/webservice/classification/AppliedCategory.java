...
public class AppliedCategory  implements java.io.Serializable {
    ...
    private org.alfresco.webservice.types.Reference[] categories;
    ...
    public AppliedCategory(
           ...
           org.alfresco.webservice.types.Reference[] categories) {
     ...
     * @return categories
     */
    public org.alfresco.webservice.types.Reference[] getCategories() {
        return categories;
    }
     ...
     * @param categories
     */
    public void setCategories(org.alfresco.webservice.types.Reference[] categories) {
        this.categories = categories;
    }

    public org.alfresco.webservice.types.Reference getCategories(int i) {
        return this.categories[i];
    }

    public void setCategories(int i, org.alfresco.webservice.types.Reference _value) {
