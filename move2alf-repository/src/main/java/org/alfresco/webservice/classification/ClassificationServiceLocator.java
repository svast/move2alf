...
public class ClassificationServiceLocator extends org.apache.axis.client.Service implements org.alfresco.webservice.classification.ClassificationService {
 ...
 */
    ...
    public org.alfresco.webservice.classification.ClassificationServiceSoapPort getClassificationService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.alfresco.webservice.classification.ClassificationServiceSoapBindingStub _stub = new org.alfresco.webservice.classification.ClassificationServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.alfresco.webservice.classification.ClassificationServiceSoapPort.class.isAssignableFrom(serviceEndpointInterface)) {
                org.alfresco.webservice.classification.ClassificationServiceSoapBindingStub _stub = new org.alfresco.webservice.classification.ClassificationServiceSoapBindingStub(new java.net.URL(ClassificationService_address), this);
                _stub.setPortName(getClassificationServiceWSDDServiceName());
                return _stub;
            }
        }
