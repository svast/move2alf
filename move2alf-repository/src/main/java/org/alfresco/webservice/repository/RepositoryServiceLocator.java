...
public class RepositoryServiceLocator extends org.apache.axis.client.Service implements org.alfresco.webservice.repository.RepositoryService {
 ...
 */
    ...
    public org.alfresco.webservice.repository.RepositoryServiceSoapPort getRepositoryService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.alfresco.webservice.repository.RepositoryServiceSoapBindingStub _stub = new org.alfresco.webservice.repository.RepositoryServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.alfresco.webservice.repository.RepositoryServiceSoapPort.class.isAssignableFrom(serviceEndpointInterface)) {
                org.alfresco.webservice.repository.RepositoryServiceSoapBindingStub _stub = new org.alfresco.webservice.repository.RepositoryServiceSoapBindingStub(new java.net.URL(RepositoryService_address), this);
                _stub.setPortName(getRepositoryServiceWSDDServiceName());
                return _stub;
            }
        }
