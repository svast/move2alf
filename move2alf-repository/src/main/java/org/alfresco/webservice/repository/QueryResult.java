...
public class QueryResult  implements java.io.Serializable {
    ...
    private org.alfresco.webservice.types.ResultSet resultSet;
    ...
    public QueryResult(
           ...
           org.alfresco.webservice.types.ResultSet resultSet) {
     ...
     * @return resultSet
     */
    public org.alfresco.webservice.types.ResultSet getResultSet() {
        return resultSet;
    }
     ...
     * @param resultSet
     */
    public void setResultSet(org.alfresco.webservice.types.ResultSet resultSet) {
        this.resultSet = resultSet;
    }
