...
public class AuthenticationServiceLocator extends org.apache.axis.client.Service implements org.alfresco.webservice.authentication.AuthenticationService {
 ...
 */
    ...
    public org.alfresco.webservice.authentication.AuthenticationServiceSoapPort getAuthenticationService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.alfresco.webservice.authentication.AuthenticationServiceSoapBindingStub _stub = new org.alfresco.webservice.authentication.AuthenticationServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.alfresco.webservice.authentication.AuthenticationServiceSoapPort.class.isAssignableFrom(serviceEndpointInterface)) {
                org.alfresco.webservice.authentication.AuthenticationServiceSoapBindingStub _stub = new org.alfresco.webservice.authentication.AuthenticationServiceSoapBindingStub(new java.net.URL(AuthenticationService_address), this);
                _stub.setPortName(getAuthenticationServiceWSDDServiceName());
                return _stub;
            }
        }
