...
public class CheckoutResult  implements java.io.Serializable {
    private org.alfresco.webservice.types.Reference[] originals;

    private org.alfresco.webservice.types.Reference[] workingCopies;

    public CheckoutResult() {
    }

    public CheckoutResult(
           org.alfresco.webservice.types.Reference[] originals,
           org.alfresco.webservice.types.Reference[] workingCopies) {
     ...
     * @return originals
     */
    public org.alfresco.webservice.types.Reference[] getOriginals() {
        return originals;
    }
     ...
     * @param originals
     */
    public void setOriginals(org.alfresco.webservice.types.Reference[] originals) {
        this.originals = originals;
    }

    public org.alfresco.webservice.types.Reference getOriginals(int i) {
        return this.originals[i];
    }

    public void setOriginals(int i, org.alfresco.webservice.types.Reference _value) {
     ...
     */
    public org.alfresco.webservice.types.Reference[] getWorkingCopies() {
        return workingCopies;
    }
     ...
     * @param workingCopies
     */
    public void setWorkingCopies(org.alfresco.webservice.types.Reference[] workingCopies) {
        this.workingCopies = workingCopies;
    }

    public org.alfresco.webservice.types.Reference getWorkingCopies(int i) {
        return this.workingCopies[i];
    }

    public void setWorkingCopies(int i, org.alfresco.webservice.types.Reference _value) {
