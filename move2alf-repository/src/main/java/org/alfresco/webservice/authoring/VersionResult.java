...
public class VersionResult  implements java.io.Serializable {
    ...
    private org.alfresco.webservice.types.Version[] versions;
    ...
    public VersionResult(
           ...
           org.alfresco.webservice.types.Version[] versions) {
           this.nodes = nodes;
     ...
     * @return versions
     */
    public org.alfresco.webservice.types.Version[] getVersions() {
        return versions;
    }
     ...
     * @param versions
     */
    public void setVersions(org.alfresco.webservice.types.Version[] versions) {
        this.versions = versions;
    }

    public org.alfresco.webservice.types.Version getVersions(int i) {
        return this.versions[i];
    }

    public void setVersions(int i, org.alfresco.webservice.types.Version _value) {
