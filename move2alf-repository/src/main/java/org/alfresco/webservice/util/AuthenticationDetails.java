...
public class AuthenticationDetails
{
     ...
     */
    public AuthenticationDetails(String userName, String ticket, String sessionId, String endpointAddress)
    {
     ...
     * 
     */
    public AuthenticationDetails(String userName, String ticket, String sessionId, long timeoutInterval, String endpointAddress)
    {
        this.userName = userName;
        this.ticket = ticket;
        this.sessionId = sessionId;
