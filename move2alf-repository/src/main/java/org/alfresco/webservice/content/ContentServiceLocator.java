...
public class ContentServiceLocator extends org.apache.axis.client.Service implements org.alfresco.webservice.content.ContentService {
 ...
 */
    ...
    public org.alfresco.webservice.content.ContentServiceSoapPort getContentService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.alfresco.webservice.content.ContentServiceSoapBindingStub _stub = new org.alfresco.webservice.content.ContentServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.alfresco.webservice.content.ContentServiceSoapPort.class.isAssignableFrom(serviceEndpointInterface)) {
                org.alfresco.webservice.content.ContentServiceSoapBindingStub _stub = new org.alfresco.webservice.content.ContentServiceSoapBindingStub(new java.net.URL(ContentService_address), this);
                _stub.setPortName(getContentServiceWSDDServiceName());
                return _stub;
            }
        }
