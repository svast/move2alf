...
public class ResultSet  implements java.io.Serializable {
    private org.alfresco.webservice.types.ResultSetRow[] rows;

    private long totalRowCount;

    private org.alfresco.webservice.types.ResultSetMetaData metaData;

    public ResultSet() {
    }

    public ResultSet(
           org.alfresco.webservice.types.ResultSetRow[] rows,
           long totalRowCount,
           org.alfresco.webservice.types.ResultSetMetaData metaData) {
           this.rows = rows;
     ...
     * @return rows
     */
    public org.alfresco.webservice.types.ResultSetRow[] getRows() {
        return rows;
    }
     ...
     * @param rows
     */
    public void setRows(org.alfresco.webservice.types.ResultSetRow[] rows) {
        this.rows = rows;
    }

    public org.alfresco.webservice.types.ResultSetRow getRows(int i) {
        return this.rows[i];
    }

    public void setRows(int i, org.alfresco.webservice.types.ResultSetRow _value) {
        this.rows[i] = _value;
    }
     ...
     * @return metaData
     */
    public org.alfresco.webservice.types.ResultSetMetaData getMetaData() {
        return metaData;
    }
     ...
     * @param metaData
     */
    public void setMetaData(org.alfresco.webservice.types.ResultSetMetaData metaData) {
        this.metaData = metaData;
    }
