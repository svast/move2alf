...
public class Predicate  implements java.io.Serializable {
    private org.alfresco.webservice.types.Reference[] nodes;

    private org.alfresco.webservice.types.Store store;

    private org.alfresco.webservice.types.Query query;

    public Predicate() {
    }

    public Predicate(
           org.alfresco.webservice.types.Reference[] nodes,
           org.alfresco.webservice.types.Store store,
           org.alfresco.webservice.types.Query query) {
           this.nodes = nodes;
           this.store = store;
           this.query = query;
    }
     ...
     * @return nodes
     */
    public org.alfresco.webservice.types.Reference[] getNodes() {
        return nodes;
    }
     ...
     * @param nodes
     */
    public void setNodes(org.alfresco.webservice.types.Reference[] nodes) {
        this.nodes = nodes;
    }

    public org.alfresco.webservice.types.Reference getNodes(int i) {
        return this.nodes[i];
    }

    public void setNodes(int i, org.alfresco.webservice.types.Reference _value) {
        this.nodes[i] = _value;
    }
     ...
     * @return store
     */
    public org.alfresco.webservice.types.Store getStore() {
        return store;
    }
     ...
     * @param store
     */
    public void setStore(org.alfresco.webservice.types.Store store) {
        this.store = store;
    }
     ...
     * @return query
     */
    public org.alfresco.webservice.types.Query getQuery() {
        return query;
    }
     ...
     * @param query
     */
    public void setQuery(org.alfresco.webservice.types.Query query) {
        this.query = query;
    }
