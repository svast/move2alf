...
public class CML  implements java.io.Serializable {
    ...
    private org.alfresco.webservice.types.CMLWriteContent[] writeContent;
    ...
    public CML(
           org.alfresco.webservice.types.CMLCreate[] create,
           org.alfresco.webservice.types.CMLAddAspect[] addAspect,
           org.alfresco.webservice.types.CMLRemoveAspect[] removeAspect,
           org.alfresco.webservice.types.CMLUpdate[] update,
           org.alfresco.webservice.types.CMLWriteContent[] writeContent,
           org.alfresco.webservice.types.CMLDelete[] delete,
           org.alfresco.webservice.types.CMLMove[] move,
           org.alfresco.webservice.types.CMLCopy[] copy,
           org.alfresco.webservice.types.CMLAddChild[] addChild,
           org.alfresco.webservice.types.CMLRemoveChild[] removeChild,
           org.alfresco.webservice.types.CMLCreateAssociation[] createAssociation,
           org.alfresco.webservice.types.CMLRemoveAssociation[] removeAssociation) {
           this.create = create;
     ...
     * @return create
     */
    public org.alfresco.webservice.types.CMLCreate[] getCreate() {
        return create;
    }
     ...
     * @param create
     */
    public void setCreate(org.alfresco.webservice.types.CMLCreate[] create) {
        this.create = create;
    }

    public org.alfresco.webservice.types.CMLCreate getCreate(int i) {
        return this.create[i];
    }

    public void setCreate(int i, org.alfresco.webservice.types.CMLCreate _value) {
     ...
     * @return addAspect
     */
    public org.alfresco.webservice.types.CMLAddAspect[] getAddAspect() {
        return addAspect;
    }
    ...
    public org.alfresco.webservice.types.CMLAddAspect getAddAspect(int i) {
        return this.addAspect[i];
    }

    public void setAddAspect(int i, org.alfresco.webservice.types.CMLAddAspect _value) {
     ...
     * @return removeAspect
     */
    public org.alfresco.webservice.types.CMLRemoveAspect[] getRemoveAspect() {
        return removeAspect;
    }
    ...
    public org.alfresco.webservice.types.CMLRemoveAspect getRemoveAspect(int i) {
        return this.removeAspect[i];
    }

    public void setRemoveAspect(int i, org.alfresco.webservice.types.CMLRemoveAspect _value) {
     ...
     * @return update
     */
    public org.alfresco.webservice.types.CMLUpdate[] getUpdate() {
        return update;
    }
     ...
     * @param update
     */
    public void setUpdate(org.alfresco.webservice.types.CMLUpdate[] update) {
        this.update = update;
    }

    public org.alfresco.webservice.types.CMLUpdate getUpdate(int i) {
        return this.update[i];
    }

    public void setUpdate(int i, org.alfresco.webservice.types.CMLUpdate _value) {
     ...
     * @return writeContent
     */
    public org.alfresco.webservice.types.CMLWriteContent[] getWriteContent() {
        return writeContent;
    }
     ...
     * @param writeContent
     */
    public void setWriteContent(org.alfresco.webservice.types.CMLWriteContent[] writeContent) {
        this.writeContent = writeContent;
    }

    public org.alfresco.webservice.types.CMLWriteContent getWriteContent(int i) {
        return this.writeContent[i];
    }

    public void setWriteContent(int i, org.alfresco.webservice.types.CMLWriteContent _value) {
     ...
     * @return delete
     */
    public org.alfresco.webservice.types.CMLDelete[] getDelete() {
        return delete;
    }
     ...
     * @param delete
     */
    public void setDelete(org.alfresco.webservice.types.CMLDelete[] delete) {
        this.delete = delete;
    }

    public org.alfresco.webservice.types.CMLDelete getDelete(int i) {
        return this.delete[i];
    }

    public void setDelete(int i, org.alfresco.webservice.types.CMLDelete _value) {
     ...
     * @return move
     */
    public org.alfresco.webservice.types.CMLMove[] getMove() {
        return move;
    }
     ...
     * @param move
     */
    public void setMove(org.alfresco.webservice.types.CMLMove[] move) {
        this.move = move;
    }

    public org.alfresco.webservice.types.CMLMove getMove(int i) {
        return this.move[i];
    }

    public void setMove(int i, org.alfresco.webservice.types.CMLMove _value) {
        this.move[i] = _value;
    }
     ...
     * @return copy
     */
    public org.alfresco.webservice.types.CMLCopy[] getCopy() {
        return copy;
    }
     ...
     * @param copy
     */
    public void setCopy(org.alfresco.webservice.types.CMLCopy[] copy) {
        this.copy = copy;
    }

    public org.alfresco.webservice.types.CMLCopy getCopy(int i) {
        return this.copy[i];
    }

    public void setCopy(int i, org.alfresco.webservice.types.CMLCopy _value) {
        this.copy[i] = _value;
    }
     ...
     * @return addChild
     */
    public org.alfresco.webservice.types.CMLAddChild[] getAddChild() {
        return addChild;
    }
     ...
     * @param addChild
     */
    public void setAddChild(org.alfresco.webservice.types.CMLAddChild[] addChild) {
        this.addChild = addChild;
    }

    public org.alfresco.webservice.types.CMLAddChild getAddChild(int i) {
        return this.addChild[i];
    }

    public void setAddChild(int i, org.alfresco.webservice.types.CMLAddChild _value) {
     ...
     * @return removeChild
     */
    public org.alfresco.webservice.types.CMLRemoveChild[] getRemoveChild() {
        return removeChild;
    }
     ...
     * @param removeChild
     */
    public void setRemoveChild(org.alfresco.webservice.types.CMLRemoveChild[] removeChild) {
        this.removeChild = removeChild;
    }

    public org.alfresco.webservice.types.CMLRemoveChild getRemoveChild(int i) {
        return this.removeChild[i];
    }

    public void setRemoveChild(int i, org.alfresco.webservice.types.CMLRemoveChild _value) {
     ...
     */
    public org.alfresco.webservice.types.CMLCreateAssociation[] getCreateAssociation() {
        return createAssociation;
    }
     ...
     */
    public void setCreateAssociation(org.alfresco.webservice.types.CMLCreateAssociation[] createAssociation) {
        this.createAssociation = createAssociation;
    }

    public org.alfresco.webservice.types.CMLCreateAssociation getCreateAssociation(int i) {
        return this.createAssociation[i];
    }

    public void setCreateAssociation(int i, org.alfresco.webservice.types.CMLCreateAssociation _value) {
     ...
     */
    public org.alfresco.webservice.types.CMLRemoveAssociation[] getRemoveAssociation() {
        return removeAssociation;
    }
     ...
     */
    public void setRemoveAssociation(org.alfresco.webservice.types.CMLRemoveAssociation[] removeAssociation) {
        this.removeAssociation = removeAssociation;
    }

    public org.alfresco.webservice.types.CMLRemoveAssociation getRemoveAssociation(int i) {
        return this.removeAssociation[i];
    }

    public void setRemoveAssociation(int i, org.alfresco.webservice.types.CMLRemoveAssociation _value) {
