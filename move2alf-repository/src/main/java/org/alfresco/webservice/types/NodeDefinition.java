...
public class NodeDefinition  implements java.io.Serializable {
    private org.alfresco.webservice.types.ClassDefinition type;

    private org.alfresco.webservice.types.ClassDefinition[] aspects;

    public NodeDefinition() {
    }

    public NodeDefinition(
           org.alfresco.webservice.types.ClassDefinition type,
           org.alfresco.webservice.types.ClassDefinition[] aspects) {
           this.type = type;
     ...
     * @return type
     */
    public org.alfresco.webservice.types.ClassDefinition getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(org.alfresco.webservice.types.ClassDefinition type) {
        this.type = type;
    }
     ...
     * @return aspects
     */
    public org.alfresco.webservice.types.ClassDefinition[] getAspects() {
        return aspects;
    }
     ...
     * @param aspects
     */
    public void setAspects(org.alfresco.webservice.types.ClassDefinition[] aspects) {
        this.aspects = aspects;
    }

    public org.alfresco.webservice.types.ClassDefinition getAspects(int i) {
        return this.aspects[i];
    }

    public void setAspects(int i, org.alfresco.webservice.types.ClassDefinition _value) {
