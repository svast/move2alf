...
public class CMLCopy  implements java.io.Serializable {
    private org.alfresco.webservice.types.ParentReference to;
    ...
    public CMLCopy(
           org.alfresco.webservice.types.ParentReference to,
     ...
     * @return to
     */
    public org.alfresco.webservice.types.ParentReference getTo() {
        return to;
    }
     ...
     * @param to
     */
    public void setTo(org.alfresco.webservice.types.ParentReference to) {
        this.to = to;
    }
