...
public class ResultSetMetaData  implements java.io.Serializable {
    private org.alfresco.webservice.types.ValueDefinition[] valueDefs;

    private org.alfresco.webservice.types.ClassDefinition[] classDefs;

    public ResultSetMetaData() {
    }

    public ResultSetMetaData(
           org.alfresco.webservice.types.ValueDefinition[] valueDefs,
           org.alfresco.webservice.types.ClassDefinition[] classDefs) {
     ...
     * @return valueDefs
     */
    public org.alfresco.webservice.types.ValueDefinition[] getValueDefs() {
        return valueDefs;
    }
     ...
     * @param valueDefs
     */
    public void setValueDefs(org.alfresco.webservice.types.ValueDefinition[] valueDefs) {
        this.valueDefs = valueDefs;
    }

    public org.alfresco.webservice.types.ValueDefinition getValueDefs(int i) {
        return this.valueDefs[i];
    }

    public void setValueDefs(int i, org.alfresco.webservice.types.ValueDefinition _value) {
     ...
     * @return classDefs
     */
    public org.alfresco.webservice.types.ClassDefinition[] getClassDefs() {
        return classDefs;
    }
     ...
     * @param classDefs
     */
    public void setClassDefs(org.alfresco.webservice.types.ClassDefinition[] classDefs) {
        this.classDefs = classDefs;
    }

    public org.alfresco.webservice.types.ClassDefinition getClassDefs(int i) {
        return this.classDefs[i];
    }

    public void setClassDefs(int i, org.alfresco.webservice.types.ClassDefinition _value) {
