...
public class RoleDefinition  implements java.io.Serializable {
    ...
    private org.alfresco.webservice.types.Cardinality cardinality;
    ...
    public RoleDefinition(
           ...
           org.alfresco.webservice.types.Cardinality cardinality) {
           this.name = name;
     ...
     * @return cardinality
     */
    public org.alfresco.webservice.types.Cardinality getCardinality() {
        return cardinality;
    }
     ...
     * @param cardinality
     */
    public void setCardinality(org.alfresco.webservice.types.Cardinality cardinality) {
        this.cardinality = cardinality;
    }
