...
public class ActionServiceLocator extends org.apache.axis.client.Service implements org.alfresco.webservice.action.ActionService {
 ...
 */
    ...
    public org.alfresco.webservice.action.ActionServiceSoapPort getActionService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.alfresco.webservice.action.ActionServiceSoapBindingStub _stub = new org.alfresco.webservice.action.ActionServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.alfresco.webservice.action.ActionServiceSoapPort.class.isAssignableFrom(serviceEndpointInterface)) {
                org.alfresco.webservice.action.ActionServiceSoapBindingStub _stub = new org.alfresco.webservice.action.ActionServiceSoapBindingStub(new java.net.URL(ActionService_address), this);
                _stub.setPortName(getActionServiceWSDDServiceName());
                return _stub;
            }
        }
