...
public class DictionaryServiceLocator extends org.apache.axis.client.Service implements org.alfresco.webservice.dictionary.DictionaryService {
 ...
 */
    ...
    public org.alfresco.webservice.dictionary.DictionaryServiceSoapPort getDictionaryService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.alfresco.webservice.dictionary.DictionaryServiceSoapBindingStub _stub = new org.alfresco.webservice.dictionary.DictionaryServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.alfresco.webservice.dictionary.DictionaryServiceSoapPort.class.isAssignableFrom(serviceEndpointInterface)) {
                org.alfresco.webservice.dictionary.DictionaryServiceSoapBindingStub _stub = new org.alfresco.webservice.dictionary.DictionaryServiceSoapBindingStub(new java.net.URL(DictionaryService_address), this);
                _stub.setPortName(getDictionaryServiceWSDDServiceName());
                return _stub;
            }
        }
